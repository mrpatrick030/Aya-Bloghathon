   ...
   <div className='py-[0.3cm]'>
    ...
    <div data-aos="fade-in" className='text-center mt-[1cm]' style={{display:"block", transition:"0.5s ease-in-out"}}>
        ...
        <div className='p-[5%] bg-[#222]'>
            ...
            <input type="text" className='px-[0.2cm] py-[0.3cm] bg-[#fff] outline-[#224] w-[100%] placeholder-[#555] mb-[0.5cm]' style={{border:"2px solid #ccf"}} required id="description" name="description" value={values.description} onChange={handleInput} placeholder="Give your post a description" />
