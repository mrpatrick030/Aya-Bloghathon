...
export default async function handler(req, res) {
  ...
  try {
    ...
    const emailCheckQuery = 'SELECT * FROM informatioadmin WHERE email = $1';
    ...
    const insertQuery = 'INSERT INTO informatioadmin (full_name, email, phone, password, country, gender) VALUES ($1, $2, $3, $4, $5, $6)';
