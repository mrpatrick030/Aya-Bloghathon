...
export default async function handler(req, res) {
  ...
  try {
    ...
    const query = 'INSERT INTO informatioblog (contributor, image_link, video_link, title, date, description, category, status) VALUES ($1, $2, $3, $4, $5, $6, $7, $8)';
    const values = [contributor, image_link, video_link, title, date, description, category, status];
